...
![Receipt Scanning Demo](Smart-Expense-Tracker/assets/videos/video_demo_ocr_scan_0.gif)

**Demostración Entrada por Voz**  
![Voice Input Demo](Smart-Expense-Tracker/assets/videos/video_demo_voice_input_0.gif)
...
![Analytics Navigation Demo](Smart-Expense-Tracker/assets/videos/video_demo_analytics_nav.gif)

**Interacción: Pulsación Larga y Detalle Diario**  
![Analytics Interaction Demo](Smart-Expense-Tracker/assets/videos/video_demo_analytics_interaction.gif)
